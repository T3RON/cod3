...
<head>
    ...
    <!-- Vendor styles -->
    <link rel="stylesheet"
        href="<?=base_url('')?>assets/vendors/bower_components/material-design-iconic-font/dist/css/material-design-iconic-font.min.css">
    ...
    <link rel="stylesheet" href="<?=base_url('')?>assets/vendors/bower_components/rateYo/min/jquery.rateyo.min.css">
    <link rel="stylesheet" href="<?=base_url('')?>assets/vendors/bower_components/dropzone/dist/dropzone.css">

    <!-- Vendor styles -->
    <link href="<?=base_url('')?>assets/css/jquery.md.bootstrap.datetimepicker.style.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?=base_url('')?>assets/vendors/bower_components/nouislider/distribute/nouislider.min.css">
    <link rel="stylesheet" href="<?=base_url('')?>assets/vendors/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.css">
...
<body data-sa-theme="1">
    <main class="main">
        ...
        <header class="header">
            ...
            <ul class="top-nav">
                <li class="hidden-xl-up"><a href="default.htm" data-sa-action="search-open"><i
                            class="zmdi zmdi-search"></i></a></li>

                <li class="dropdown">
                    <a href="default.htm" data-toggle="dropdown" class="top-nav__notify"><i
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu--block">
                        ...
                        <div class="listview listview--hover">
                            <a href="default.htm" class="listview__item">
                                <img src="<?=base_url('')?>assets/demo/img/profile-pics/1.jpg" class="listview__img"
                                    alt="">
                            ...
                            <a href="default.htm" class="listview__item">
                                <img src="<?=base_url('')?>assets/demo/img/profile-pics/2.jpg" class="listview__img"
                                    alt="">
                            ...
                            <a href="default.htm" class="listview__item">
                                <img src="<?=base_url('')?>assets/demo/img/profile-pics/3.jpg" class="listview__img"
                                    alt="">
                            ...
                            <a href="default.htm" class="listview__item">
                                <img src="<?=base_url('')?>assets/demo/img/profile-pics/4.jpg" class="listview__img"
                                    alt="">
                            ...
                            <a href="default.htm" class="listview__item">
                                <img src="<?=base_url('')?>assets/demo/img/profile-pics/5.jpg" class="listview__img"
                                    alt="">
                ...
                <li class="hidden-xs-down">
                    <a href="default.htm" class="top-nav__themes" data-sa-action="aside-open"
                        data-sa-target=".themes"><i class="zmdi zmdi-palette"></i></a>
                </li>
            </ul>
            ...
            <div class="scrollbar-inner">
                ...
                <ul class="navigation">
                    ...
                    <li class="@@variantsactive">
                        <a href="<?= base_url('panel/Digikala/index'); ?>"><i class="zmdi zmdi-view-week"></i> افزودن
                            محصول</a>


                    </li>

                    <li class="@@typeactive"><a href="<?= base_url('panel/Refresh/update'); ?>"><i
                                class="zmdi zmdi-format-underlined"></i> بروز رسانی قیمت</a></li>

                    <li class="@@widgetactive"><a href="<?= base_url('panel/Cate/index'); ?>"><i
                                class="zmdi zmdi-widgets"></i> دسته بندی</a></li>
                    <li class="@@widgetactive"><a href="<?= base_url('panel/Sub/index'); ?>"><i
                                class="zmdi zmdi-widgets"></i>زیر دسته بندی </a></li>
                    ...
                    <li class="navigation__sub @@uiactive">
                        ...
                        <ul>
                            ...
                            <li class="@@cssanimationsactive"><a href="css-animations.html">انیمیشن های سی اس اس</a>
                            </li>
                    ...
                    <li class="navigation__sub @@componentsactive">
                        ...
                        <ul class="navigation__sub">
                            ...
                            <li class="@@notificationsactive"><a href="notifications-alerts.html">نوتیفیکیشن و آلرت</a>
                            </li>
                    ...
                    <li class="@@calendaractive"><a href="calendar.html"><i class="zmdi zmdi-calendar"></i> تقویم</a>
                    </li>
        ...
        <div class="themes">
            <div class="scrollbar-inner">
                <a href="default.htm" class="themes__item active" data-sa-value="1"><img
                        src="<?=base_url('')?>assets/img/bg/1.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="2"><img
                        src="<?=base_url('')?>assets/img/bg/2.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="3"><img
                        src="<?=base_url('')?>assets/img/bg/3.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="4"><img
                        src="<?=base_url('')?>assets/img/bg/4.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="5"><img
                        src="<?=base_url('')?>assets/img/bg/5.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="6"><img
                        src="<?=base_url('')?>assets/img/bg/6.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="7"><img
                        src="<?=base_url('')?>assets/img/bg/7.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="8"><img
                        src="<?=base_url('')?>assets/img/bg/8.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="9"><img
                        src="<?=base_url('')?>assets/img/bg/9.jpg" alt=""></a>
                <a href="default.htm" class="themes__item" data-sa-value="10"><img
                        src="<?=base_url('')?>assets/img/bg/10.jpg" alt=""></a>
            </div>
        </div>