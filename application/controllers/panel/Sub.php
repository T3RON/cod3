...
class Sub extends CI_Controller {
    ...
    function index()
    {
        ...
        $this->load->view('panel/Sub',$output);
    }
    ...
    function insert()
    {
        ...
        $data = array(
			'sub_cate_title' => $this->input->post('sub_cate_title'),
			'cate_id' => $this->input->post('cate_id')
		);
		$result= $this->MY_Model->insert('sub_cate',$data);

        redirect('panel/Sub/index');
    }
    ...
    function delete () { 
        ...
        $result= $this->MY_Model->delete('sub_cate',$id);
        if ($result) {
            redirect('panel/Sub/index');
         }else {
             redirect('panel/Sub/index');
